...
`r fa("link", fill = "#562457")`https://andrewmaclachlan.github.io/Spatial-analysis-of-public-health-data-23/#1

`r fa("file-pdf", fill = "#562457")` [PDF presentation](https://github.com/andrewmaclachlan/Spatial-analysis-of-public-health-data-23/blob/main/index.pdf)
...
`r fa("paper-plane", fill = "#562457")` [laura.sheppard.20@ucl.ac.uk](mailto:laura.sheppard.20@ucl.ac.uk)
`r fa("twitter", fill = "#562457")` [laurahsheppard](https://twitter.com/laurahsheppard)
`r fa("github", fill = "#562457")` [LauraSheppard](https://github.com/LauraSheppard)]


`r fa("map-pin", fill = "#562457")` [Centre for Advanced Spatial Analysis, UCL](https://www.ucl.ac.uk/bartlett/casa/)
...
* Teaching Fellow and now lecturer in The Barlett Centre for Advanced Spatial Analysis + lead our MSc/MRes Urban Spatial Science
...
* Multiplied by the sum of the distances $d_ij$ between all points within a search radius
...
```{r echo=FALSE, out.width='40%', fig.align='center'}
knitr::include_graphics('img/Anselin.jpg')
```
